<template>
	<div>
		...
		<div class="content">
			<div class="header clear"><h2><img :src="articleData.author_face" alt=""/></h2><p>vue2app</p></div>
		    <div class="cont">
...
<script>
	...
	export default{
		...
		methods:{
			fetchData(_id){
				var _this=this;
				this.$http.get('http://localhost:8000/article_api?id='+_id).then(function(res){
